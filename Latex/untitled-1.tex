...
\end{tikzpicture}
			...
			\end{figure}
				...
				\end{itemize}
			\par Hình 2 mô tả ý tưởng giải thuật SVR, tồn tại các điểm nằm ngoài vùng hai đường biên và đồng thời  chỉ có các đó mới gây nên sai số theo công thức hàm  Vapnik's $\epsilon - insensitive$.
