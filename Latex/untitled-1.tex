...
\end{tikzpicture}
	...
	\section{Phương pháp đề xuất}								
		...
		\subsection{Mô hình dự đoán}
			...
			\par \textit{Ý tưởng}
			\par Số bài review và số điểm trung bình trong tương lai của một địa điểm ăn uống nhận được trong tương lai chỉ phụ thuộc vào dữ liệu của địa điểm trong một chuỗi thời gian trước đó. 
			...
			\par Một mẫu dữ liệu luôn có: tập thuộc tính và giá trị mong muốn. Cụ thể:
				\begin{itemize}
			...
			\par Để tạo một mẫu dữ liệu cho việc học: ta chọn ngẫu nhiên dữ liệu trong $(n+1)$ khoảng thời gian liên tiếp trong dữ liệu học. Sử dụng dữ liệu của $n$ khoảng thời gian trước để tạo tập các thuộc tính và khoảng thời gian cuối cùng để tạo giá trị đầu ra mong muốn (target). 	 
			...
			\par \textbf{Mô hình 3: Tập thuộc tính gồm các nhóm 5.5.2, 5.5.3, 5.5.4}
