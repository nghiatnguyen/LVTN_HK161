...
%----------------------------------------------------------------------------------------
\HRule \\[0.4cm]
{ \huge \bfseries Dự đoán mức độ thu hút của\\địa điểm ăn uống trong tương lai}\\[0.4cm] % Title of your document
\HRule \\[0.8cm]
...
Nguyễn Trọng Nghĩa - 51202370\\[2.5cm]
\end{flushleft}
...
\end{tikzpicture}
			...
			\par Người chủ địa điểm ăn uống có thể vào trang mạng \textit{foody.vn} xem các review và rating mà người dùng dành cho địa điểm của mình, từ đó đánh giá được độ thu hút của địa điểm ở thời điểm hiện tại. Sẽ là hữu ích nếu có một hệ thống dự đoán trước được số lượng các review và điểm rating đối với địa điểm của họ trong tương lai. Những thông tin này sẽ là căn cứ để người chủ địa điểm xem xét mức độ thu hút của địa điểm trong tương lai và có thể đưa ra giải pháp cải thiện. Đối tượng hướng đến của đề tài là những người chủ địa điểm đó.
...
\section{Kiến thức nền tảng}
		\subsection{Tối ưu tập thuộc tính}
			...
			\par \textbf{Univariate Feature Analysis}
				...
				\par  \textit{Nhược điểm}
				\par Những thuộc tính tốt nhất mà thuật toán chọn ra đều ảnh hưởng độc lập đến kết quả bài toán. Tuy nhiên, đôi khi việc kết hợp các thuộc tính không tốt với nhau cũng có thể đưa ra mô hình dự đoán tốt. \\[30pt]
			\par \textbf{Recursive Feature Elimination}
				...
				\par \textit{Phương pháp}
				\begin{enumerate}
					\item Cho giải thuật học dựa trên tập các thuộc tính và sau đó gán trọng số (\textit{Ví dụ}: hệ số của mô hình tuyến tính) cho mỗi thuộc tính.
...
\end{tikzpicture}
			...
			\begin{figure}[h!]
				...
				\label{fig:svr}
			\end{figure}
		\footnotetext{\textit{Tham khảo:} Kang Yu, Georg Leufen (2013) Investigation of Leaf Diseases and Estimation of Chlorophyll Concentration in Seven Barley Varieties Using Fluorescence and Hyperspectral Indices}	
	...
	\section{Phương pháp đề xuất}	
		...
		\subsection{Mô hình dự đoán}
			...
			\begin{itemize}
				\item Mô hình 1: Tập thuộc tính chỉ gồm nhóm 5.2.1
				\item Mô hình 2: Tập thuộc tính chỉ gồm nhóm 5.2.2
				\item Mô hình 3: Tập thuộc tính gồm các nhóm 5.2.2, 5.2.3 và 5.2.4
			\end{itemize}
			\par Với mỗi mô hình, từ tập thuộc tính ban đầu, nhóm tạo ra được 4 tập thuộc tính khác nhau và sau đó áp dụng giải thuật SVR lần lượt trên mỗi tập thuộc tính đó, bao gồm:
			\begin{itemize}
			...
			\par Để áp dụng các giải thuật tối ưu tập thuộc tính (PCA, Univariate Feature Analysis, Recursive Feature Elimination) có thể dùng thư viện scikit-learn \footnote[1]{http://scikit-learn.org} (python).
