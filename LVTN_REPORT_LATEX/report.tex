	...
	\chapter{Thực nghiệm và đánh giá}						
		...
		Dựa vào bảng kết quả 6.1, chúng tôi có một số nhận xét trực quan:
			\begin{itemize}
				...
				\item{Hệ thống EOA đạt kết quả không cao hơn nhiều so với hệ thống cơ sở, độ F cao hơn khoảng 1\% . Điều này cho thấy đặc trưng \textit{Sự kết hợp giữa thực thể và từ chỉ ý kiến (EOA)} đã có ảnh hưởng tích cực đến hệ thống, tuy nhiên vì một số lí do nào đó đặc trưng này tỏ ra không ảnh hưởng nhiều đến kết quả}.
