		...
		\section{Tạo tập dữ liệu học và kiểm tra}
			...
			\subsection*{Tạo các vectơ đặc trưng}
				...
				\subsubsection*{Đặc trưng Nhất quán về ý kiến (SENTIMENT\_CONSISTENCY)}
					...
					\par (2) Nếu s(i-1) là câu so sánh (câu so sánh được xác định dựa trên một số luật như câu chứa các chỉ định so sánh tương tự như trong đặc trưng số 10 "is between") và s(i) là câu bình thường
					\begin{itemize}
