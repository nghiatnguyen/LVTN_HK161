...
%----------------------------------------------------------------------------------------
\HRule \\[0.4cm]
{ \huge \bfseries Giải quyếti đồng tham chiếu \\ cho đối tượng và thuộc tính \\ trong khai khoáng ý kiến}\\[0.4cm] % Title of your document
\HRule \\[0.8cm]
...
\newpage
	\chapter*{Lời cảm ơn}
		\par Trước tiên, chúng tôi xin gửi lời cảm ơn sâu sắc tới cô giáo GS.TS Phan Thị Tươi, người đã luôn theo sát hướng dẫn và giúp đỡ tận tình chúng tôi trong suốt quá trình thực hiện Luận văn để chúng tôi hoàn thành đề tài Luận văn của mình. Bên cạnh đó chúng tôi cũng muốn gửi lời cảm ơn chân thành tới các thầy cô của Khoa Khoa học và kỹ thuật máy tính - trường Đại học Bách Khoa TP. Hồ Chí Minh, những kiến thức mà các thầy cô truyền đạt thực sự là những hành trang hữu ích mà chúng tôi có được trong suốt những năm tháng học đại học. Cuối cùng, chúng tôi xin được gửi lời tri ân tới gia đình và bạn bè, những người đã luôn ủng hộ chúng tôi về mặt tinh thần để chúng tôi có được những kết quả ngày hôm nay. 
\newpage
	\chapter*{Tóm tắt Luận văn}		
		...
		\par Luận văn được tổ chức thành 6 chương. Chương 1 nêu ra vấn đề và giới thiệu đề tài \textit{Phân giải đồng tham chiếu cho đối tượng và thuộc tính trong Khai khoáng ý kiến}, chương này cũng đồng thời nói về phạm vi và mục đích của đề tài. Trong chương 2, chúng tôi nói về các công trình liên quan đến đề tài mà chúng tôi thực hiện, chúng là cơ sở quan trọng trong việc hình thành nên phương pháp đề xuất của chúng tôi. Chương 3 là các kiến thức nền tảng được sử dụng trong việc thực hiện đề tài, đó là các nội dung về bài toán Phân giải đồng tham chiếu, Khai khoáng ý kiến và giải thuật học máy Cây quyết định. Chương 4 nói về Phương pháp đề xuất và cách hiện thực hệ thống giải quyết bài toán đặt ra. Trong chương 5, các kết quả thực nghiệm và các đánh giá, phân tích của chúng tôi được dẫn ra. Cuối cùng, chúng tôi tổng kết lại Luận văn của mình trong chương cuối - chương 6.
		\begin{flushright}
			Nhóm tác giả
		\end{flushright}
...
\newpage		
	...
	\chapter{Các công trình liên quan}				
		\section{Các công trình liên quan đến phân giải đồng tham chiếu nói chung}
			...
			\subsection*{Mô hình cặp (Mention pair)}
				\par Ý tưởng:  Xác định các cặp đồng tham chiếu, sau đó kết hợp các cặp đồng tham chiếu đã tìm được thành các chuỗi đồng tham chiếu. Bài toán trở thành bài toán phân loại kết hợp gom cụm, phân loại tích cực nếu cặp đồng tham chiếu và tiêu cực nếu cặp không đồng tham chiếu.
				\begin{figure}[H]
					\centering
				...
				\end{figure}
				\par Hình \ref{fig:mentionpair} trình bày ý tưởng các bước thực hiện trong mô hình cặp. Theo như mô hình, mỗi tác giả sẽ có một cách riêng khi thực hiện các bước:
				\begin{itemize}
				...
				\begin{itemize}
					...
					\item{Cách kết hợp kết quả từ các cặp: 
						...
						\begin{itemize}
							\item{Giải thuật gom cụm gần nhất (closest-first clustering) được đề xuất bởi Soon (2001)\cite{soon01}: Nếu có các cặp được dự đoán đồng tham chiếu mà hậu từ của chúng giống nhau thì Soon chỉ giữ lại cặp đồng tham chiếu có khoảng cách từ tiền từ đến hậu từ là gần nhất.}
							\item{Giải thuật gom cụm tốt nhất (best-first clustering) được sử dụng bởi Ng và Cardie (2002)\cite{ng02}: Nếu có các cặp được dự đoán đồng tham chiếu mà hậu từ của chúng giống nhau thì Ng chỉ giữ lại cặp đồng tham chiếu được dự đoán với trọng số (khả năng) cao nhất.}
			...
			\par \textit{Căn cứ theo giải thuật được sử dụng trong bài toán đồng tham chiếu, các công trình liên quan được chia làm 3 nhóm được trình bày dưới đây, gồm: giải thuật học có giám sát, giải thuật học không giám sát và hệ thống luật}
				...
				\subsection*{Hệ thống luật}
					...
					\par Mô hình này được biết đến đầu tiên bởi Baldwin (1995)\cite{baldwin95}. Ý tưởng của tác giả là kết hợp tập các luật có độ đúng đắn cao (high precision) theo một thứ tự hợp lý để thu được độ phủ (recall) chấp nhận được. Sau đó có nhiều tác giả cũng hiện thực phương pháp này dưới những tên gọi khác nhau như: Brown (1993)\cite{brown93}, Collins và Singer (1999)\cite{collin99}, Spitkovsky (2010)\cite{spitkovsky10}, Li và Liu (2015)\cite{li15}.
					\par Mô hình sử dụng và cải tiến hệ thống luật đưa lại kết quả cao nhất là mô hình của Lee và Chang (2012)\cite{lee12}. Hình \ref{fig:rules} minh họa cho mô hình mà Lee sử dụng. Trong bài báo, tác giả đề xuất một tập gồm 10 luật, các luật này được sắp xếp có thứ tự dựa vào độ đúng đắn (precion) và độ phủ (recall) mà mỗi luật mang lại cho hệ thống. Luật càng đứng trước thì độ đúng đắn càng cao, luật càng đứng sau thì độ đúng đắn càng thấp nhưng độ phủ mang lại càng cao. Dữ liệu văn bản sau khi trích xuất ra được các cụm danh từ NPs, các cụm danh từ này lần lượt được kiểm tra với từng luật để tìm đồng tham chiếu, kết quả đầu ra của luật trước là đầu vào của luật sau. Kết quả đầu ra của luật cuối cùng cũng chính là kết quả của hệ thống các luật. Không chỉ áp dụng hệ thống luật, tác giả còn kết hợp với mô hình thực thể để cải tiến kết quả bài toán. Ví dụ về luật số 1 của hệ thống: Luật quy định nếu người nói là "I" thì từ "my" trong câu nói của người đó sẽ đồng tham chiếu với "I". Ví dụ: Trong câu \textit{"I said "my phone is broken""}, câu văn trên khi đi qua luật số 1 sẽ cho ra kết quả là "I" và "my" đồng tham chiếu.
					\begin{figure}[h]
						\centering
	...
	\chapter{Kiến thức nền tảng}	
		...
		\section{Khai khoáng ý kiến}
			\subsection*{Khái quát}
				...
				Đối tượng o gồm một tập các thuộc tính F = \{$f_1$, $f_2$, $f_3$, …\} gồm cả o cũng là một thuộc tính đặc biệt (tổng quát – general). Mỗi thuộc tính $f_i$ thuộc F được diễn đạt bằng một hoặc nhiều từ/cụm từ ở trong văn bản (gọi là các synonyms của thuộc tính).
				...
				\item{Dạng 1: Các từ chỉ ý kiến không phụ thuộc ngữ cảnh (context independent)
					\begin{itemize}
						...
						\item{Đối với các từ so sánh thuộc nhóm 2, cũng có thể dễ dàng dùng các luật sau để tìm ra (tập) đối tượng được ưu tiên.				
							...
							\\Trong đó Negative là từ chỉ ý kiến tiêu cực, Positive là từ chỉ ý kiến tích cực. Increasing Comparative là \textit{more}, Decreasing Comparative là \textit{less}.}
					\end{itemize}}
	...
	\chapter{Phương pháp đề xuất và hiện thực}	
		...
		\section{Tổng quan quy trình}
			\par Hình \ref{fig:generalmodel} thể hiện tổng quan các bước thực hiện phân giải đồng tham chiếu mà chúng tôi đã thực hiện.
			\begin{figure}[H] 
				\centering				
		...
		\section{Trích xuất cụm danh từ}
			\subsection*{Tìm và lọc các cụm danh từ}
				...
				\par Sau đây trình bày một ví dụ về bước trích xuất cụm danh từ:
					...
					\\Dùng công cụ Stanford để gán nhãn từ loại và dùng CRFChunker để ghép cụm cho đoạn văn bản trên, ta có kết quả như hình \ref{fig:crfchunker}:
			...
			\subsection*{Gán nhãn cho cụm danh từ}
				...
				\par Gán nhãn bằng tay là công việc chứa đựng nhiều nguy cơ sai sót, đặc biệt trên một khối lượng dữ liệu lớn. Do vậy, nhằm tránh những lỗi sai và đồng thời tăng tốc độ làm việc, chúng tôi đã viết một công cụ giúp gán nhãn dữ liệu bằng Java kết hợp với gói giao diện Swing (hình \ref{fig:markup}). Công cụ này lấy đầu vào là các văn bản đã được trích xuất cụm danh từ và xuất ra văn bản được gán nhãn như ví dụ này. Bằng các thao tác kích chuột đơn giản, có thể chọn TYPE và chuỗi đồng tham chiếu (các cụm danh từ chung chuỗi thì chung màu) cho các cụm danh từ, sau đó xuất kết quả (Export).
		...
		\section{Tạo tập dữ liệu học và kiểm tra}
			\subsection*{Tạo tập dữ liệu học}
				...
				\par Tập mẫu dùng để học (Instances): mọi cặp (NP1, NP2) được tạo ra từ danh sách L và thỏa mãn điều kiện NP1 hoặc NP2 là cụm danh từ là tên đối tượng/thuộc tính (TYPE = 0 hoặc TYPE = 3). Lý do là vì đề tài chỉ thực hiện với mục đích phân giải đồng tham chiếu cho các đối tượng/thuộc tính đã biết.
				\\Đặc điểm mỗi mẫu dữ liệu để học:
				\begin{itemize}
					\item{Tập thuộc tính: đã được đề cập ở bảng \ref{features_table}.}
				...
				\begin{figure}[H]
					...
					\label{fig:trainset}
				\end{figure}
				\subsection*{Tạo tập dữ liệu kiểm tra}
				\par Cách tạo tập dữ liệu kiểm tra hoàn toàn giống với cách tạo tập dữ liệu học.

			\subsection*{Tạo các vectơ đặc trưng}

				\par Giả sử các cặp \textit{mention} gồm hai cụm danh từ (NP1, NP2). Bảng \ref{features_table} tóm tắt tất cả các đặc trưng mà chúng tôi sử dụng. Sau đây chúng tôi trình bày các đặc trưng được sử dụng trong hệ thống.
				...
				\subsubsection*{Đặc trưng NP1 là đại từ (NP1\_PRONOUN)}
					...
					\par \textit{Giá trị:} [true, false] Đặc trưng nhận giá trị true nếu NP1 là đại từ và ngược lại nhận giá trị false. Đại từ được nhắc đến bao gồm: đại từ phản thân (itself, themselves), tân ngữ (it, them), đại từ nhân xưng (it, they) và tính từ sở hữu (its, their).



				\subsubsection*{Đặc trưng NP2 là đại từ (NP2\_PRONOUN)}
					\par \textit{Giải thích:} Là khả năng cụm danh từ NP2 là đại từ.
					\par \textit{Giá trị:} [true, false]. Đặc trưng nhận giá trị true nếu NP2 là đại từ và ngược lại nhận giá trị false.
				...
				\subsubsection*{Đặc trưng Giống nhau hoàn toàn (EXACT\_MATCH)}
					...
					\par \textit{Giá trị:} [true, false]. Đặc trưng nhận giá trị true nếu hai cụm danh từ giống nhau hoàn toàn và nhận giá trị false nếu ngược lại.

				\subsubsection*{Đặc trưng Danh từ chính giống nhau (HEAD\_MATCH)}
					\par \textit{Giải thích:} Là sự giống nhau giữa hai cụm danh từ.
					\par \textit{Giá trị:} [true, false]. Đặc trưng nhận giá trị true nếu danh từ chính của hai cụm danh từ giống nhau và nhận giá trị false nếu ngược lại.
				...
				\subsubsection*{Đặc trưng Chuỗi con của nhau (SUBSTRING)}
					...
					\par \textit{Giá trị:} [true, false]. Đặc trưng nhận giá trị true nếu hai cụm danh từ là chuỗi con của nhau và nhận giá trị false nếu ngược lại.
				...
				\subsubsection*{Đặc trưng Từ hạn định (DEF\_NP2)}
					...
					\par \textit{Giá trị:} [true, false]. Đặc trưng nhận giá trị true nếu NP2 là cụm danh từ xác định và false nếu ngược lại.
				...
				\subsubsection*{Đặc trưng Từ chỉ trỏ (DEM\_NP2)}
					...
					\par \textit{Giá trị:} [true, false]. Đặc trưng nhận giá trị true nếu NP2 là cụm danh từ chỉ định và false nếu ngược lại.

				\subsubsection*{Đặc trưng Tên riêng (PROPER\_NAME)}
					\par \textit{Giải thích:} Là khả năng cả hai cụm danh từ đều là tên riêng.
					\par \textit{Giá trị:} [true, false]. Đặc trưng nhận giá trị true nếu cả hai cụm danh từ đều là tên riêng và nếu không phải thì nhận giá trị false.
				...
				\subsubsection*{Đặc trưng Từ chỉ ý kiến (OPINION\_WORD)}
					...
					\begin{center}
						...
						\end{equation*}
					\end{center}
					\par Giá trị PMI không chỉ biểu hiện mối quan hệ giữa một OW và một NP, mà còn cho ta thấy mối quan hệ giữa cụm danh từ mà OW đang nói đến với NP. Do đó, từ giá trị PMI tính được, chúng tôi tạo đặc trưng mới OPINION\_WORD cho mỗi mẫu để biểu thị mối quan hệ giữa cặp hai cụm danh từ. Dưới đây là cách hiện thực của chúng tôi: 
					\par Cụm danh từ NP1 có từ chỉ ý kiến đi kèm là OW1. Đầu tiên, chúng tôi tính giá trị PMI( NP\textsubscript{$i$},OW1) với  NP\textsubscript{$i$} là các cụm danh từ nằm trước NP1. Kết quả là chúng tôi thu được danh sách các giá trị PMI. Cụm danh từ  NP\textsubscript{$i$} nào có giá trị PMI( NP\textsubscript{$i$},OW1) cao nhất thì đặc trưng OPINION\_WORD của mẫu tạo bởi  NP\textsubscript{$i$} đó và NP1 là 0, cao thứ nhì thì OPINION\_WORD = 1, cao thứ ba thì OPINION\_WORD = 2, cao thứ tư thì OPINION\_WORD = 3, còn lại OPINION\_WORD = 4. Với trường hợp NP1 không có từ chỉ ý kiến kèm theo, hoặc các giá trị P(NP,OW) = 0, P(NP) = 0, P(OW) = 0 thì  các mẫu tạo bởi cặp đó với các từ đứng trước có giá trị đặc trưng OPINION\_WORD = 10. OPINION\_WORD càng nhỏ thể hiện khả năng hai cụm danh từ có quan hệ càng cao, càng có khả năng đồng tham chiếu với nhau.
					\par Ví dụ: "The phone does not hold a charge long enough to last the day and it’s expensive."
					\\Câu trên có 3 cụm danh từ NP1 "the phone", NP2 "a charge", NP3 "it". Từ chỉ ý kiến OW3 "expensive" đi kèm với NP3. Để tính giá trị đặc trưng OPINION\_WORD cho các cặp (NP1,NP3) và (NP2 NP3), trước tiên ta sẽ tính PMI(NP1, OW3) và PMI(NP2, OW3). Sau khi tính toán, thu được PMI(NP2, OW3) nhỏ hơn PMI(NP1, OW3), khi đó OPINION\_WORD(NP1, NP3) = 0, OPINION\_WORD(NP2, NP3) = 1.
					\par Trong trường hợp một NP có nhiều hơn một từ chỉ ý kiến. Quan hệ giữa hai cụm danh từ không còn dựa trên một từ chỉ ý kiến mà phải dựa vào tập từ chỉ ý kiến. Giá trị PMI dùng để xây dựng giá trị đặc trưng OPINION\_WORD bây giờ là giá trị PMI trung bình. Ví dụ NP1 có OW1 và OW2. Quan hệ giữa cụm từ  NP\textsubscript{$i$} với N1 không còn chỉ dựa vào PMI( NP\textsubscript{$i$},OW1) hoặc PMI( NP\textsubscript{$i$}, OW2) mà dựa vào giá trị PMI trung bình của chúng. Ta lần lượt tính giá trị PMI( NP\textsubscript{$i$},OW1) và PMI( NP\textsubscript{$i$}, OW2), giá trị PMI của  NP\textsubscript{$i$} với tập từ ý kiến là:
				...
				\subsubsection*{Đặc trưng Từ khóa "is" nằm ở giữa (IS\_BETWEEN)}
					\par \textit{Giải thích:} Nếu ở giữa 2 cụm danh từ trong câu có từ "is" hoặc các động từ TOBE như "are", "was", "were", "been",... và nó không đi kèm với bất kỳ chỉ định so sánh hay phủ định nào thì có xác suất để 2 cụm danh từ này đồng tham chiếu. Nếu ở giữa 2 cụm danh từ trong câu có từ "is" (hoặc một động từ TOBE) và nó có đi kèm với một chỉ định so sánh nào thì có xác suất để 2 cụm danh từ này trỏ tới 2 đối tượng/thuộc tính khác nhau.
					\par \textit{Giá trị:} [true, false]. Đặc trưng nhận giá trị true nếu ở giữa 2 cụm danh từ trong câu có từ "is" (hoặc một động từ TOBE) đồng thời không có chỉ định so sánh hay phủ định nào, ngược lại nhận giá trị false.
					\par Về việc xác định các chỉ định so sánh, các chỉ định so sánh được tìm kiếm bằng cách bắt các từ/cụm từ thuộc các mẫu so sánh phổ biến (đã đề cập ở mục \ref{comparative_section}). Các diễn đạt phủ định đi kèm như "is not", "isn't", "were not",... cũng được xem xét và những trường hợp này cho giá trị đặc trưng là false.
					\par Ví dụ: 
				...
				\subsubsection*{Đặc trưng Từ khóa "has" nằm ở giữa (HAS\_BETWEEN)}
					...
					\par \textit{Giá trị:} [true, false]. Đặc trưng nhận giá trị true nếu ở giữa 2 cụm danh từ trong câu có từ "has", ngược lại nhận giá trị false.
					\par Ví dụ:
					"My MiPad has a 5MP front camera". "My MiPad" và "a 5MP front camera" khả năng trỏ tới 2 đối tượng/thuộc tính khác nhau.
									
					\par \textit{Phương pháp hiện thực:}
					\\Nếu giữa hai cụm danh từ có chứa từ "has" hoặc "have" hoặc "had" và từ đi kèm sau chúng không phải là "to" hay động từ nhóm 3 (nhãn POS là "VBN") thì đặc trưng HAS\_BETWEEN của cặp hai cụm danh từ là true. Trong những trường hợp còn lại HAS\_BETWEEN bằng false.
				...
				\subsubsection*{Đặc trưng đại từ quan hệ (RELATIVE\_PRONOUN)}
					...
					\par \textit{Giá trị:} [true, false]. Nếu NP2 được tạo thành từ đại quan hệ không chỉ người (các từ có nhãn từ loại là WHNP ngoại trừ "who"), đặc trưng nhận giá trị true. Ngược lại cho giá trị false. 
				...
				\subsubsection*{Đặc trưng Nhất quán về ý kiến (SENTIMENT\_CONSISTENCY)}
					...
					\par Ký hiệu s(i-1) và s(i) là hai câu liên tiếp trong văn bản. Đối với đặc trưng này, có hai trường hợp cần xét tới:
						\begin{itemize}
					...
					\begin{itemize}
						\item{Nếu thiên hướng ý kiến đối với NP1 và NP2 là giống nhau (cùng tích cực hoặc tiêu cực), đồng thời câu s(i) không bắt đầu bằng một từ chỉ sự đối lập như \textit{but}, \textit{however} hay \textit{contrary to},... thì chúng có khả năng là đồng tham chiếu.}
					...
					\par (2) Nếu s(i-1) là câu so sánh và s(i) là câu bình thường. Câu s(i-1) được xác định là câu so sánh dựa trên các từ khóa như đề cập ở mục \ref{comparative_section}.
					\begin{itemize}
						...
						\item{Dựa vào thiên hướng ý kiến của câu so sánh(i-1), như đã đề cập ở mục \ref{comparative_section} thiên hướng ý kiến của câu so sánh có thể được tìm ra dựa vào từ khóa so sánh. Ví dụ: s(i-1) là một câu so sánh có dạng \textit{NP1 is better than NP2}, vì "better" có thiên hướng so sánh tích cực nên ta xác định được đối tượng ưu tiên trong phép so sánh này là NP1. Khi đó nếu câu s(i) không bắt đầu với một từ chỉ số đối lập như \textit{but}, \textit{however} hay \textit{contrary to},... thì: nếu thiên hướng ý kiến đối với NP3 là tích cực thì NP3 có khả năng đồng tham chiếu với NP1, ngược lại nó có khả năng đồng tham chiếu với NP2.
						\\ Ví dụ:
						\\"I want to admit Lumia 920 is by far better than the iPhone! Learn how to use, and it's amazing!" 
						\\Nhờ từ khóa so sánh "better", ta xác định được đây là câu so sánh và đối tượng ưu tiên là "Lumia 920". Ở câu tiếp theo do thiên hướng đối với đại từ "it" là tích cực (dựa vào từ chỉ ý kiến "amazing" gắn với nó) nên "it" có khả năng đang nói tới đối tượng "Lumia 920", theo tính chất nhất quán về ý kiến trong ngôn ngữ.}
					\end{itemize}
					\par Để xác định được thiên hướng ý kiến đối với 1 cụm danh từ bất kỳ, chúng tôi sử dụng từ chỉ ý kiến. Nếu không có từ chỉ ý kiến nào đi kèm thì cụm danh từ đó được xác định là không rõ thiên hướng ý kiến. Khi xét tới các từ chỉ ý kiến, chúng tôi cũng cân nhắc sự phủ định đi kèm với chúng bởi phép phủ định làm đảo ngược thiên hướng ý kiến ban đầu. Để tìm ra các phép phủ định này, chúng tôi dựa vào phân tích văn phạm phụ thuộc bằng công cụ Stanford. Ví dụ: "The battery is not good, but the screen is very bright." Câu này có 2 từ chỉ ý kiến đều có thiên hướng tích cực là "good" đi kèm với "the battery" và "bright" đi kèm với "the screen". Tuy nhiên "good" nằm trong mối quan hệ phủ định \textit{neg(good-5, not-4)}, do đó thiên hướng ý kiến của nó đã bị đảo ngược trở thành tiêu cực. Như đã đề cập, các từ chỉ ý kiến hầu hết đều là tính từ hoặc trạng từ và qua phân tích văn phạm phụ thuộc, và nếu chúng đi kèm nghĩa phủ định, chúng thường nằm trực tiếp hay gián tiếp trong một mối quan hệ \textit{neg} nào đó. Có thể thấy điều này ở một ví dụ khác: "It's not a good phone to hold in your hand". Phân tích văn phạm phụ thuộc cho câu này cho kết quả có chứa 2 quan hệ là \textit{neg(phone-6, not-3)} và \textit{amod(phone-6, good-5)}, nhờ đó ta biết được rằng có một phép phủ định tác động lên từ chỉ ý kiến "good". Kết quả thiên hướng ý kiến đối với "It" và "a good phone" trong câu này đều là tiêu cực.

		\section{Tạo bộ phân loại và gom cụm}									
			\subsection*{Áp dụng phương pháp Chọn lại mẫu}
				\par Tập dữ liệu dùng để học có sự chênh lệch lớn giữa số lượng các mẫu được phân loại tích cực và số lượng các mẫu được phân loại tiêu cực, cụ thể: chọn một fold ngẫu nhiên, số lượng mẫu học được phân loại tích cực là 4130 và số lượng mẫu học được phân loại tiêu cực là 31686. Sự chênh lệnh lớn này ảnh hưởng đến kết quả của giải thuật phân loại, theo Weiss \cite{weiss03}. Một trong những lý do đó là giải thuật phân loại được học các mẫu tiêu cực quá nhiều thì khả năng giải thuật phân loại sẽ tập trung học những trường hợp tiêu cực nhiều hơn.
				\par Tình trạng tập dữ liệu chênh lệch trong học máy là phổ biến, chúng tôi sử dụng cách thường được sử dụng để khắc phục là phương pháp chọn lại mẫu (resampling methods). Ý tưởng của phương pháp này là xây dựng lại tập dữ liệu học, chọn ngẫu nhiên có hoàn lại các mẫu từ tập dữ liệu học ban đầu và chuyển vào tập dữ liệu học mới. Đặc điểm của tập dữ liệu học mới này là tỉ số giữa số mẫu tích cực và số mẫu tiêu cực gần về 1, sự chênh lệch được giảm đi. Ví dụ: tập dữ liệu ban đầu có M mẫu dữ tích cực, N mẫu dữ liệu tiêu cực, với M >> N. Tập dữ liệu học mới gồm (M - T) mẫu tích cực và (N + T) mẫu tiêu cực (T là số mẫu tích cực đã được loại bỏ, cũng là số mẫu tiêu cực tăng lên). Giá trị T tùy thuộc vào cách lựa chọn của mỗi người sử dụng.
	...
	\chapter{Thực nghiệm và đánh giá}						
		\section{Thực nghiệm}
			\subsection*{Chương trình}
				...
				\begin{itemize}
					...
					\item{gui: Gói liên quan đến giao diện, trong đó có giao diện của công cụ giúp gán nhãn dữ liệu và công cụ xem kết quả đồng tham chiếu.}
					\item{process: Gói liên quan đến quá trình trích xuất đặc trưng hoặc gán nhãn dữ liệu.}
			...
			\subsection*{Dữ liệu thực nghiệm}
				\par Dữ liệu dùng cho đề tài được thu thập từ các bài đánh giá (review) trên amazon.com và các bài thảo luận (discussion) từ http://www.howardforums.com/. Đây là các bài đánh giá và thảo luận về điện thoại. Tập dữ liệu của chúng tôi bao gồm 157 bài, với mỗi bài có trung bình 7-8 câu. Trên các bài đó, người dùng thể hiện ý kiến lên chủ thể là các đối tượng (nhắc bởi tên của điện thoại) và các thuộc tính của chúng. Bên cạnh đó, có nhiều câu so sánh cũng được sử dụng, đó là các so sánh giữa các đối tượng trên một thuộc tính nào đó. Hình \ref{fig:amazon} thể hiện một bài đánh giá mà chúng tôi đã thu thập.
				\begin{figure}[H]
					\centering				
					\noindent\fbox{
					    \parbox{\textwidth}{
		...
		\section{Các phương pháp đánh giá}			
				...
				\\Một số khái niệm được sử dụng trong 3 phương pháp:
					\begin{itemize}
						...
						\item{p($S_i$): tập hợp các cụm $P_j$ của chuỗi $S_i$. Mỗi cụm $P_j$ chứa các cụm danh từ, tối thiểu là một cụm danh từ. Cách tìm $P_j$: Trước tiên ta tìm các cụm $P_j$ mà mỗi $P_j$ bằng $S_i$ giao $R_k$. Sau đó, nếu có cụm danh từ nào trong $S_i$ mà không nằm trong bất kì một chuỗi $P_j$ đã tạo nào, thì ta sẽ tạo ra thêm chuỗi $P_j$ mới chứa cụm danh từ đó. Ví dụ: Từ dữ liệu gồm chuỗi $S_1$ = \{A B C D E\} và 2 chuỗi $R_1$ = \{A B\}, $R_2$ = \{C E\}. Khi đó $P_1$ = $S_1 \cap R_1$ = \{A B\}, $P_2$ = $S_1 \cap R_2$ = \{C E\}. Phần tử D trong $S_1$ vẫn chưa nằm trong cụm $P_1$ hay $P_2$, do đó ta tạo thêm cụm $P_3$ = \{D\}.}							
				...
				\par Công thức tính độ đúng đắn (P) và độ phủ (R): 
					\begin{center}
						\begin{equation*}
					...
					\begin{itemize}
						\item{độ đúng đắn của NP\textsubscript{$i$} bằng số cụm danh từ trong $output\_chain$ cũng nằm trong $truth\_chain$ chia cho số cụm danh từ trong $output\_chain$}.
		...
		Bảng 6.1 trình bày kết quả thực nghiệm trên các hệ thống.
				...
				Hình \ref{fig:chart_muc}, \ref{fig:chart_b3}, \ref{fig:chart_ceaf4} trình bày biểu đồ so sánh hiệu năng giữa các hệ thống. Các kết quả này là độ F trên 3 hệ đo MUC, B3, CEAF-$\Phi_4$ trong 5 lần kiểm chứng chéo.

				\begin{figure}[H] 			
					\centering					
					\includegraphics[scale=0.7]{charts/chart_muc.pdf}					
					\caption{So sánh kết quả giữa các hệ thống trên hệ đo MUC}
					\label{fig:chart_muc}
				\end{figure} 

				\begin{figure}[H] 
					\centering					
					\includegraphics[scale=0.7]{charts/chart_b3.pdf}					
					\caption{So sánh kết quả giữa các hệ thống trên hệ đo B3}
					\label{fig:chart_b3}
				\end{figure}

				\begin{figure}[H] 
					\centering					
					\includegraphics[scale=0.7]{charts/chart_ceaf4.pdf}					
					\caption{So sánh kết quả giữa các hệ thống trên hệ đo CEAF-$\Phi_4$}
					\label{fig:chart_ceaf4}
				\end{figure}
		...
		Dựa vào bảng kết quả 6.1, chúng tôi có một số nhận xét trực quan:
			\begin{itemize}
				\item{Hệ thống đầy đủ đạt kết quả cao hơn hệ thống cơ sở, cụ thể có độ F cao hơn khoảng 3\% đến 6\% (tùy hệ đo). Điều này chứng tỏ các đặc trưng liên quan đến Khai khoáng ý kiến đã ảnh hưởng tích cực đến kết quả, chúng có giá trị đối với bài toán đồng tham chiếu trên lĩnh vực khai khoáng ý kiến}.
				\item{Hệ thống SC đạt kết quả cao hơn hệ thống cơ sở, cụ thể có độ F cao hơn khoảng 4\% đến 6\% (tùy hệ đo). Điều này cho thấy đặc trưng \textit{Tính nhất quán về ý kiến (SC)} đã có ảnh hưởng tương đối lớn đến hệ thống}.
				\item{Hệ thống EOA đạt kết quả không cao hơn nhiều so với hệ thống cơ sở, độ F cao hơn khoảng 1\% . Điều này cho thấy đặc trưng \textit{Sự kết hợp giữa thực thể và từ chỉ ý kiến (EOA)} đã có ảnh hưởng tích cực đến hệ thống, tuy nhiên vì một số lý do nào đó đặc trưng này tỏ ra không ảnh hưởng nhiều đến kết quả}.
				\item{Hệ thống đầy đủ có kết quả thấp hơn một ít so với hệ thống SC. Điều này cho thấy việc kết hợp hai đặc trưng mới \textit{Tính nhất quán về ý kiến (SC)} và \textit{Sự kết hợp giữa thực thể và từ chỉ ý kiến (EOA)} vẫn còn gặp vấn đề}.
			\end{itemize}
		\subsection*{Giải thích}
			...
			\par \textit{Nguyên nhân đặc trưng \textit{Sự kết hợp giữa thực thể và từ chỉ ý kiến (EOA)} chưa ảnh hưởng nhiều đến hệ thống:}
				\begin{itemize}
					\item{Số lượng từ chỉ ý kiến trong tập dữ liệu vẫn chưa nhiều (chỉ có 442 trong số 2634 từ chỉ đối tượng, thuộc tính có từ chỉ ý kiến đi kèm). Do đó đặc trưng EOA vẫn chưa ảnh hưởng nhiều đến hệ thống}.
					...
					\item{Theo giả thuyết cặp nào có giá trị đặc trưng EOA càng nhỏ thì càng có khả năng đồng tham chiếu. Tuy nhiên trên thực tế có những cặp có giá trị đặc trưng EOA nhỏ (0 hoặc 1) nhưng không đồng tham chiếu, trong khi có nhiều cặp có giá trị EOA lớn (3 hoặc 4) thì cặp đó lại đồng tham chiếu}.
					\item{Tập dữ liệu học của đặc trưng EOA bị nhiễu. Một cụm danh từ có từ chỉ ý kiến nhưng trên thực tế nằm trong chuỗi đồng tham chiếu nào sẽ tạo ra các mẫu học có giá trị đặc trưng EOA là 0,1,2,3,4, dẫn đến hệ thống học được rằng dù đặc trưng EOA là 0 hoặc 1 thì vẫn phân loại là không đồng tham chiếu. Chúng tôi thống kê thấy có 57 cụm danh từ có dạng như vậy}.
				\end{itemize}
			\par \textit{Nguyên nhân đặc trưng \textit{Tính nhất quán về ý kiến (SC)} chưa ảnh hưởng nhiều đến hệ thống}:
				\begin{itemize}
					\item{Giải thuật tìm thiên hướng ý kiến gắn với đối tượng/thuộc tính được nêu ra trong câu vẫn còn đơn giản và chỉ cho kết quả đúng đối với các câu tương đối đơn giản. Đối với dữ liệu thực tế mà minh chứng là dữ liệu do chúng tôi thu thập, có một số lượng nhất định các câu phức và việc xác định thiên hướng ý kiến trong các câu này chưa cho hiệu quả cao.}					
				\end{itemize}
			\par \textit{Một số lý do làm cho hệ thống vẫn chưa đạt kết quả cao}:
				\begin{itemize}
					\item{Trong lĩnh vực khai khoáng ý kiến, mỗi bài đánh giá xuất hiện nhiều đối tượng và thuộc tính, do đó rất khó để xác định đồng tham chiếu nếu không dựa vào hai đặc trưng cơ bản liên quan đến khai khoáng ý kiến (\textit{Sự kết hợp giữa thực thể và từ chỉ ý kiến} và \textit{Tính nhất quán về ý kiến}). Tuy nhiên, vì một số lý như chúng tôi đã trình phần trên, hai đặc trưng đó vẫn chưa có nhiều ảnh hưởng đến hệ thống}.
					...
					\item{Đặc trưng \textit{Danh từ chính giống nhau} ảnh hưởng nhiều đến độ đúng đắn của hệ thống. Bởi vì đặc trưng này mà Cây quyết định học được rằng nếu hai cụm danh từ có danh từ chính giống nhau và cụm danh từ đứng trước không phải là đại từ thì cây quyết định của hệ thống phân loại đồng tham chiếu. Tuy nhiên, trên thực tế có nhiều trường hợp danh từ chính giống nhau nhưng chúng không đồng tham chiếu, ví dụ: "the camera quality" và "the image quality" được hệ thống phân loại là đồng tham chiếu vì đều có danh từ chính "quality"}.
				\end{itemize}
		
	\chapter{Tổng kết}	
		\section*{Kết quả đạt được}				
		\begin{itemize}
			\item{Về mặt cơ sở lý luận, từ những nghiên cứu về phân giải đồng tham chiếu và các kiến thức liên quan đến Khai khoáng ý kiến, chúng tôi đã đề ra được phương pháp đề xuất để giải quyết bài toán \textit{Phân giải đồng tham chiếu cho đối tượng và thuộc tính trong Khai khoáng ý kiến}.}			
			\item{Về mặt thực nghiệm, chúng tôi đã tự xây dựng tập dữ liệu và hiện thực hệ thống giải quyết bài toán dựa trên phương pháp đề xuất. Hệ thống của chúng tôi cho kết quả đầu ra khả quan.}
			\item{Để giải quyết bài toán một cách có hiệu quả hơn, trong quá trình hiện thực chúng tôi có xây dựng một số công cụ nhằm giúp gán nhãn dữ liệu hoặc hiển thị kết quả gom cụm đồng tham chiếu trên văn bản bằng giao diện.}
		\end{itemize}
		...
		\begin{itemize}
			\item{Khai khoáng ý kiến đang ngày càng trở thành một lĩnh vực quan trọng và thu hút ngày càng nhiều các nhà nghiên cứu quan tâm tới nó. Trong tương lai, có thể tìm thêm những đặc trưng liên quan đến Khai khoáng ý kiến khác để áp dụng vào hệ thống phân giải đồng tham chiếu nhằm tăng độ chính xác.}
			...
			\item{Thử nghiệm cho tiếng Việt:
				\begin{itemize}
					...
					\\Hình \ref{fig:jvntextpro} là kết quả đầu ra sau khi xử lý văn bản trên bằng JVnTextPro.
					\begin{figure}[H]
						\centering				
						\noindent\fbox{
						    \parbox{\textwidth}{
						...
						\label{fig:jvntextpro}
					\end{figure}
					VnDP \footnote{https://sourceforge.net/projects/vndp/files/VnDPv1.0.1.zip} là công cụ dùng cho phân tích văn phạm phụ thuộc trong tiếng Việt. Bảng \ref{table_vndp} trình bày ví dụ phân tích văn phạm phụ thuộc cho câu "iPhone 6s sẽ nặng hơn iPhone 6 14g, iPhone 6s dài, dày, rộng hơn iPhone 6 chút ít, nhưng người ta khó nhận ra bằng mắt thường bởi con số này chỉ tính là một vài mm, thậm chí chưa đến 1 mm.".
					\begin{table}	
						\centering													
						...
						\label{table_vndp}
					\end{table}	
					Dựa trên kết quả gán nhãn từ loại bằng công cụ JVnTextPro, có thể tìm các cụm danh từ nhờ vào công cụ gom từ VietChunker \footnote{http://vlsp.hpda.vn:8080/demo/?page=resources\&tool=chunker}.	
					}					
					\item{Các nghiên cứu liên quan đến Phân giải đồng tham chiếu và Khai khoáng ý kiến trong tiếng Việt cũng đã xuất hiện trong những năm gần đây. (Lê Đức Trọng, 2011) trong \cite{leductrong11} đã áp dụng mô hình học máy có giám sát SVM trên dữ liệu thu thập từ vnexpress.net, mô hình phân giải đồng tham chiếu của tác giả trên dữ liệu này cho độ đúng đắn 76.51\%. Trong \cite{vn_sentiment1} và \cite{vn_sentiment2}, các tác giả cũng đã đưa ra mô hình Khai khoáng ý kiến cho văn bản tiếng Việt.}
				\end{itemize}
