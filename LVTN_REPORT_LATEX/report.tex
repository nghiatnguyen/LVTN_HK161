...
\newpage
	...
	\chapter{Phương pháp đề xuất}	
		...
		\section{Tổng quan quy trình}
			...
			\end{figure}			
		\par Dữ liệu thu thập được sẽ được tiền xử lý nhằm giúp giảm sai số cho các bước sau. Bước tiền xử lý đảm bảo đặc tính ngôn ngữ của văn bản không thay đổi. Sau đây trình bày một số thao tác tiền xử lý mà nhóm đã thực hiện:		\section{Tiền xử lý dữ liệu}
