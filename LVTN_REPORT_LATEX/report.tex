...
\newpage
	...
	\chapter{Thực nghiệm và đánh giá}						
		...
		Bảng 6.1 trình bày kết quả thực nghiệm trên các hệ thống.
				...
				Hệ thống cơ sở  &  0.654        &  0.555        &  0.666        &   0.666       &   0.666       & 0.666        & 0.666          & 0.666          &         0.666  \\ \hline
				Hệ thống SC     &          &          &          &          &          &         &           &           &           \\ \hline
				Hệ thống EOA 	&          &          &          &          &          &         &           &           &           \\ \hline
		...
		Dựa vào bảng kết quả 6.1, chúng tôi có một số nhận xét trực quan:
			\begin{itemize}
				...
				\item{Hệ thống EOA đạt kết quả không cao hơn nhiều so với hệ thống cơ sở, cao hơn khoảng ???\% độ F. Điều này cho thấy đặc trưng \textit{Sự kết hợp giữa thực thể và từ chỉ ý kiến (EOA)} đã có ảnh hưởng tiêu cực đến hệ thống, tuy nhiên vì một số lí do nào đó đặc trưng này tỏ ra không hiệu quả khi được sử dụng}.
			\end{itemize}
		\subsection*{Giải thích}
			...
			\par \textit{Nguyên nhân hệ thống vẫn chưa đạt kết quả cao}:
				\begin{itemize}
					\item{Trong lĩnh vực khai khoáng ý kiến, một bài đánh giá xuất hiện nhiều đối tượng và thuộc tính, rất khó để xác định đồng tham chiếu nếu không dựa vào vào hai đặc trưng cơ bản liên quan đến khai khoáng ý kiến (\textit{Sự kết hợp giữa thực thể và từ chỉ ý kiến} và \textit{Tính nhất quán về ý kiến}). Tuy nhiên, vì một số lí do chúng tôi đã trình phần trên, hai đặc trưng đó vẫn chưa có nhiều ảnh hưởng đến hệ thống}.
